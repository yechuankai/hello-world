...
import com.wms.web.shiro.realm.UserRealmImpl;
...
import com.wms.web.shiro.web.filter.LogoutFilter;
...
public class ShiroConfig {
	...
	protected InputStream getCacheManagerConfigFileInputStream() {
		...
		try {
			inputStream = ResourceUtils.getInputStreamForPath(ehcacheCinfig);
	 ...
	 */
	@Bean
	public UserRealmImpl userRealm(EhCacheManager cacheManager) {
		UserRealmImpl userRealm = new UserRealmImpl();
	 ...
	 */
	@Bean
	public SecurityManager securityManager(UserRealmImpl userRealm) {
