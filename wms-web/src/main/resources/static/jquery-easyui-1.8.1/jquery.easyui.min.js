...
try{$(this).tooltip("tip").css({color:"#000",borderColor:"#CC9933",backgroundColor:"#FFFFCC"});}catch(e){}
},onHide:function(){
$(this).tooltip("destroy");
...
//yechuankai 
form.attr('data-json', JSON.stringify(data));
}
...
//yechuankai 加载grid
var cb=$.data(this,"combogrid");
var cbp=$(this).combo("panel");
var opts=cb.options;
var grid=cb.grid;
if(!grid){
grid=$("<table data-options=''></table>").appendTo(cbp);
cb.grid=grid;
grid.datagrid(cb.gridOps);
}else{grid.datagrid(cb.gridOps);};
...
//yechuankai 不直接加载grid
//var _bc7=$(_bc2).combo("panel");
//if(!grid){
//grid=$("<table data-options=''></table>").appendTo(_bc7);
//_bc3.grid=grid;
//}
...
gridOps=$.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:_bc8,onClickRow:_bc9,onSelect:_bca("onSelect"),onUnselect:_bca("onUnselect"),onSelectAll:_bca("onSelectAll"),onUnselectAll:_bca("onUnselectAll")});
_bc3.gridOps=gridOps;
function _bcb(dg){
...
//yechuankai 没有加载grid情况下直接退出
if(!grid){$(_bdf).combo("setValues", _be0); $(_bdf).combo("setText", _be0);return;}
...
//yechuankai 没有加载日期框时不处理逻辑
if(_c81){_c81.calendar("moveTo",opts.parser.call(_c7d,_c7e));}
if(_c7f){
$(_c7d).combo("setValue",_c7e);
}else{
if(_c7e){
//yechuankai 没有加载日期框时不处理逻辑
if(_c81){_c7e=opts.formatter.call(_c7d,_c81.calendar("options").current);}
}
...
if(!$(_c92).datebox("calendar")){
opts.onShowPanel.call(this.target);
...
if($(this).datetimebox("spinner")){
return $.fn.datebox.defaults.formatter.call(this,date)+" "+$.fn.timespinner.defaults.formatter.call($(this).datetimebox("spinner")[0],date);
}else{
var hour=_fffff(date.getHours());
var _6f0=_fffff(date.getMinutes());
var _6f1=_fffff(date.getSeconds());
return $.fn.datebox.defaults.formatter.call(this,date)+' '+hour+':'+_6f0+':'+_6f1;
}
function _fffff(v){
return (v<10?"0":"")+v;
};
...
var xx=dt[1].split(":");
return new Date(_cb2.getFullYear(),_cb2.getMonth(),_cb2.getDate(),xx[0],xx[1],xx[2]);
}
}});
})(jQuery);
(function($){
