...
public class InboundHeaderTEntity extends BaseEntity {
    ...
    public Date getContainerNumber() {
        return containerNumber;
    }

    public void setContainerNumber(Date containerNumber) {
    ...
    public static class Builder {
         ...
         * @project https://github.com/itfsw/mybatis-generator-plugin
         */
        public Builder containerNumber(Date containerNumber) {
    ...
    public enum Column {
        ...
        containerNumber("CONTAINER_NUMBER", "containerNumber", "TIMESTAMP", false);
